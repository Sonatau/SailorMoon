...
@Component({
  selector: 'app-search-coures',
  templateUrl: './search-coures.component.html',
  styleUrls: ['./search-coures.component.scss'],
})
export class SearchCouresComponent implements OnInit {
